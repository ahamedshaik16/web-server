            ...
            <div class="row">
                ...
                <div class="col-xs-6">
					 ...
					 $sqlGallery = "SELECT * from acceptedtechnicalevents";
						...
						$rws = mysql_fetch_array($sqlGalleryResult)
					 ?>
						...
						$sqlVideo = "SELECT * from acceptedtechnicalevents where eventNameId = '$eventNameId'";
						$sqlVideoResult=mysql_query($sqlVideo);
						$rwssqlVideoResult = mysql_fetch_array($sqlVideoResult);

						
						$file = "../handler/documents/".$rwssqlVideoResult['eventNameId']."/video.mp4";
							...
							if(file_exists($file))
							{
									...
									<div class="col-md-6">
								<a href="../events/event1.php?eventname=<?php echo $rwssqlVideoResult['eventName']; ?>&eventid=<?php echo $rwssqlVideoResult['eventNameId'];?>" class="thumbnail" style="width:620px;height:500px">
									<p><?php echo $rwssqlVideoResult[1]; ?></p>
