...
<!-- creating gallery -->
        ...
        <div class="container">
			...
			<div class="row">	
					...
					$file = "../handler/documents/".$rws[0]."/image.jpeg";

					if(file_exists($file)){
					?>
					
<div class="col-md-4">
      <a href="../events/event1.php?eventname=<?php echo $rws['eventName']; ?>&eventid=<?php echo $rws['eventNameId'];?>" class="thumbnail">
        <p><?php echo $rws['eventName']; ?></p>
        <img class="image" src="<?php echo $file; ?>"  style="width:150px;height:150px">
