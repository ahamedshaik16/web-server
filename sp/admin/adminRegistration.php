    ...
    <div class="container content">
        <div class="row">
            <div class="col-xs-12 col-sm-12 well well-sm">
                <div class="form-wrap">
                    <legend><i class="glyphicon glyphicon-globe"></i>Admin Sign up!</legend>
                    <form action="#" method="post" class="form" role="form">
                        <div class="row">
                            <div class="col-xs-6 col-md-6">
                                <input class="form-control" name="firstName" placeholder="First Name" type="text" pattern="['A-Za-z']" title="No Special Characters and numbers"
                                       required autofocus />
                            </div>
                            <div class="col-xs-6 col-md-6">
                                <input class="form-control" name="lastName" placeholder="Last Name" type="text" required pattern="['A-Za-z']" title="No Special Characters and numbers"/>
                            </div>
                        </div>
						...
						<label class="radio-inline">
                            <input type="radio" name="typeOfHandler" id="inlineCheckbox1" value="adminRole" checked/>
                            adminRole
                        </label>
						<br />
					
                        
                                <input class="form-control" name="adminCode" placeholder="Enter Given admin code" type="password" required />
...
if( $_POST)
{
	if ($securimage->check($_POST['captcha_code']) == false) 
	{
		...
		{	
			...
			$previousAdminCode = "TechnoTrendz";
			$enteredAdminCode = $_REQUEST['adminCode'];
			$typeOfHandler = $_REQUEST['typeOfHandler'];
			
			
			$sqlEmail = "Select count(*) as emailValue from adminRegistration where email='$email'";
			...
			if($enteredAdminCode == $previousAdminCode )
			{
				if(preg_match($pattern, $password))
				{
						...
						{ 			
								...
								{
									$resetPassword = 'NULL';
									$sql="Insert into adminRegistration values('$firstName','$lastName','$email','$password','$resetPassword','$typeOfHandler')";
									mysql_query($sql);
										...
										$_SESSION['typeOfHandler'] = $_REQUEST['typeOfHandler'];
										...
										//echo "".$_SESSION['firstName'];
										 ...
										 $mailbody = "You are successfully registered as Admin";
			...
			{
			?> <script type="text/javascript">
						 alert("Please enter valid admin code");
				</script>
			<?php
			}
