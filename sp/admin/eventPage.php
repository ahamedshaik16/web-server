        ...
        <div class="container">
            <div class="row">
				...
				<?php if (isset($_GET["page"]))
					...
					{
						$sql = "select eventName,dateOfEvent,eventNameId,accept from newregisteredevents where dateOfEvent='$dat' ORDER BY eventNameId DESC LIMIT $start_from, 4"; }
                       ...
                       <a href="../admin/specificEvent.php?eventname=<?php echo $rws[0]; ?>&eventid=<?php echo $rws[2];?>">
                           <div class="row">
                             ...
                             <!--  <div class="col-xs-5"><span>Event Handler Name</span></div> -->
							   ...
							   <div class="col-xs-3"><span>Checked</span></div>
                           ...
                           <div class="row">
							   ...
							   <div class="col-xs-3"><?php echo $rws[3]; ?></div>
...
?>
				...
				<?php if (isset($_GET["page"]))
							{ $page  = $_GET["page"]; } 
								...
								$start_from = ($page-1) * 4;  
					$sql="select eventName,dateOfEvent,eventNameId,accept from newregisteredevents ORDER BY eventNameId DESC LIMIT $start_from, 4";
								$result=mysql_query($sql);
								while($rws = mysql_fetch_array($result)){
                    ...
                    <div id="eventName1" class="eventHeader">
                       ...
                       <a href="../admin/specificEvent.php?eventname=<?php echo $rws[0]; ?>&eventid=<?php echo $rws[2];?>&accept=<?php echo $rws[3];?>">
                           <div class="row">
                               <div class="col-xs-4"><span>Event Name</span></div>
                             <!--  <div class="col-xs-5"><span>Event Handler Name</span></div> -->
                               <div class="col-xs-3"><span>Date</span></div>
